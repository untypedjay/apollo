...
namespace Apollo.Core.Test
{
    public class ReservationDaoTests
    {
        ...
        {
            Reservation reservation = await reservationDao.FindByIdAsync(23);
            Assert.Equal("SAAL 6", reservation.Show.CinemaHall.Name);
        }
        ...
        {
            Reservation updatedReservation = await reservationDao.FindByIdAsync(23);
            Reservation result = await reservationDao.FindByIdAsync(23);
            ...
            Reservation result2 = await reservationDao.FindByIdAsync(23);
